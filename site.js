const NEON_I18N = {
  en: {
    ...
    meta: {
      ...
      homeDescription: "Neon Eye is an independent precision timing game by Gaborandi with a 100-stage campaign, practice modes, leaderboards, purchases, ads, consent, and clear privacy details.",
    ...
    home: {
      ...
      promiseTwoText: "Practice, Flux, and daily play",
      ...
      modePracticeTitle: "Practice",
      modePracticeText: "A low-friction place to feel the rhythm, calibrate input, and build consistency.",
      modeFluxTitle: "Flux",
      ...
      progressOne: "The first screen leads with the actual game surface: Campaign, Practice, Flux, Leaderboard, Cosmetics, and Settings.",
      ...
      lookCaption: "Theme preview rendered directly by the launch site.",
    },
    privacy: {
...
for (const lang of ["fr", "de", "pt", "it", "ja", "ko", "zh"]) {
  NEON_I18N[lang] = {
    ...NEON_I18N.en,
    common: {
      ...NEON_I18N.en.common,
