const NEON_I18N = {
  en: {
    ...
    home: {
      ...
      promiseOneTitle: "100 stages",
      promiseOneText: "Campaign built around pressure",
      promiseTwoTitle: "Fast modes",
      promiseTwoText: "Zen, Flux, and daily play",
      promiseThreeTitle: "Player controls",
      promiseThreeText: "Consent, privacy, and support",
      ...
      featureOneText: "The target is simple, but the pressure comes from motion, rhythm, and the shrinking perfect window.",
      featureTwoTitle: "Climb the campaign",
      featureTwoText: "Campaign progress, medals, mastery goals, and challenge modes give each clean hit a purpose.",
      featureThreeTitle: "Respect the player",
      featureThreeText: "Ads and online features are documented here, controlled by consent where required, and supported by clear choices.",
      modesEyebrow: "Launch modes",
      modesTitle: "One input, several kinds of pressure.",
      modesText: "Neon Eye keeps the rule simple, then changes the reason you care about each hit: stage progress, warmup, score pressure, cosmetics, and leaderboard attempts.",
      modeCampaignTitle: "Campaign",
      modeCampaignText: "A 100-stage path where the timing window tightens and clean hits matter more.",
      modePracticeTitle: "Zen",
      modePracticeText: "A lower-pressure place to feel the rhythm, settle into the target, and build consistency.",
      modeFluxTitle: "Flux",
      modeFluxText: "A sharper scoring mode for players who want the same timing language under changing pressure.",
      modeMetaTitle: "Leaderboard And Cosmetics",
      modeMetaText: "Optional online ranking and cosmetic progress give clean runs a public and personal record.",
      ...
      lookCaption: "Actual screenshots captured from the current Neon Eye build.",
      menuShotCaption: "Current main menu from the game build.",
      campaignShotCaption: "Campaign timing screen.",
      fluxShotCaption: "Flux pressure screen.",
    },
    privacy: {
      ...
      purchaseText: "In-app purchases are processed by Apple StoreKit. We store entitlement state needed to unlock purchases such as Remove Ads and Battle Pass Premium, plus any future App Store products if they are offered later. Apple processes payment information.",
    ...
    support: {
      ...
      restoreText: "Use Restore Purchases inside Neon Eye. If restore does not work, include the product you purchased and the Apple account region used for the purchase.",
      privacyTitle: "Privacy Requests",
      privacyText: "For privacy access, correction, deletion, or consent-choice questions, include enough information to identify the relevant app-generated player record. Apple purchase history and Game Center account data must also be managed through Apple's account tools.",
    },
  },
  ar: {
...
Object.assign(NEON_I18N.ar.home, {
  ...
  progressOne: "الشاشة الأولى تقود إلى الحملة وZen وFlux واليومي وBattle Pass ولوحات الصدارة والمظاهر والمتجر والإعدادات.",
  lookCaption: "لقطات فعلية من الإصدار الحالي للعبة Neon Eye.",
  menuShotCaption: "القائمة الرئيسية الحالية من إصدار اللعبة.",
  campaignShotCaption: "شاشة توقيت الحملة.",
  fluxShotCaption: "شاشة ضغط Flux.",
});

Object.assign(NEON_I18N.ar.meta, {
  homeDescription: "Neon Eye لعبة توقيت دقيقة مستقلة من Gaborandi مع حملة من 100 مرحلة وأوضاع Zen وFlux ولوحات صدارة ومشتريات وإعلانات وموافقة وتفاصيل خصوصية واضحة.",
});
...
Object.assign(NEON_I18N.es.home, {
  ...
  progressOne: "La primera pantalla muestra Campaña, Zen, Flux, Diario, Battle Pass, Clasificación, Cosméticos, Tienda y Ajustes.",
  lookCaption: "Capturas reales de la versión actual de Neon Eye.",
  menuShotCaption: "Menú principal actual de la build del juego.",
  campaignShotCaption: "Pantalla de timing de Campaña.",
  fluxShotCaption: "Pantalla de presión de Flux.",
});

Object.assign(NEON_I18N.es.meta, {
  homeDescription: "Neon Eye es un juego móvil independiente de precisión de Gaborandi con campaña de 100 fases, modos Zen y Flux, clasificaciones, compras, anuncios, consentimiento y detalles claros de privacidad.",
});

for (const lang of ["fr", "de", "pt", "it", "ja", "ko", "zh", "ru", "tr", "hi", "id", "nl", "pl", "sv", "vi"]) {
  NEON_I18N[lang] = {
    ...NEON_I18N.en,
    common: {
      ...NEON_I18N.en.common,
      ...
      footer: {
        fr: "Neon Eye est un jeu mobile indépendant de Gaborandi.",
        de: "Neon Eye ist ein unabhängiges Mobile Game von Gaborandi.",
        pt: "Neon Eye é um jogo móvel independente da Gaborandi.",
        it: "Neon Eye è un gioco mobile indipendente di Gaborandi.",
        ja: "Neon Eye は Gaborandi による独立系モバイルゲームです。",
        ko: "Neon Eye는 Gaborandi의 독립 모바일 게임입니다.",
        zh: "Neon Eye 是 Gaborandi 制作的独立手机游戏。",
        ru: "Neon Eye — независимая мобильная игра от Gaborandi.",
        tr: "Neon Eye, Gaborandi tarafından geliştirilen bağımsız bir mobil oyundur.",
        hi: "Neon Eye, Gaborandi का स्वतंत्र मोबाइल गेम है।",
        id: "Neon Eye adalah game seluler independen dari Gaborandi.",
        nl: "Neon Eye is een onafhankelijke mobiele game van Gaborandi.",
        pl: "Neon Eye to niezależna gra mobilna od Gaborandi.",
        sv: "Neon Eye är ett fristående mobilspel av Gaborandi.",
        vi: "Neon Eye là game di động độc lập của Gaborandi.",
      }[lang],
    },
    meta: {
      ...NEON_I18N.en.meta,
      homeTitle: {
        fr: "Neon Eye | Jeu de précision",
        de: "Neon Eye | Präzisionsspiel",
        pt: "Neon Eye | Jogo de precisão",
        it: "Neon Eye | Gioco di precisione",
        ja: "Neon Eye | 精密タイミングゲーム",
        ko: "Neon Eye | 정밀 타이밍 게임",
        zh: "Neon Eye | 精准计时游戏",
        ru: "Neon Eye | Игра на точность тайминга",
        tr: "Neon Eye | Hassas Zamanlama Oyunu",
        hi: "Neon Eye | सटीक टाइमिंग गेम",
        id: "Neon Eye | Game Timing Presisi",
        nl: "Neon Eye | Precisietiming-game",
        pl: "Neon Eye | Gra precyzyjnego timingu",
        sv: "Neon Eye | Precisionsspel",
        vi: "Neon Eye | Game canh thời điểm chính xác",
      }[lang],
      termsTitle: {
        ...
        ru: "Условия Neon Eye | Gaborandi",
        tr: "Neon Eye Şartları | Gaborandi",
        hi: "Neon Eye शर्तें | Gaborandi",
        id: "Ketentuan Neon Eye | Gaborandi",
        nl: "Neon Eye voorwaarden | Gaborandi",
        pl: "Warunki Neon Eye | Gaborandi",
        sv: "Neon Eye villkor | Gaborandi",
        vi: "Điều khoản Neon Eye | Gaborandi",
      }[lang],
      privacyTitle: {
        fr: "Politique de confidentialité de Neon Eye | Gaborandi",
        de: "Neon Eye Datenschutzrichtlinie | Gaborandi",
        pt: "Política de Privacidade do Neon Eye | Gaborandi",
        it: "Informativa privacy di Neon Eye | Gaborandi",
        ja: "Neon Eye プライバシーポリシー | Gaborandi",
        ko: "Neon Eye 개인정보 처리방침 | Gaborandi",
        zh: "Neon Eye 隐私政策 | Gaborandi",
        ru: "Политика конфиденциальности Neon Eye | Gaborandi",
        tr: "Neon Eye Gizlilik Politikası | Gaborandi",
        hi: "Neon Eye गोपनीयता नीति | Gaborandi",
        id: "Kebijakan Privasi Neon Eye | Gaborandi",
        nl: "Neon Eye privacybeleid | Gaborandi",
        pl: "Polityka prywatności Neon Eye | Gaborandi",
        sv: "Neon Eye integritetspolicy | Gaborandi",
        vi: "Chính sách quyền riêng tư Neon Eye | Gaborandi",
      }[lang],
      supportTitle: {
        ...
        ru: "Поддержка Neon Eye | Gaborandi",
        tr: "Neon Eye Destek | Gaborandi",
        hi: "Neon Eye सहायता | Gaborandi",
        id: "Dukungan Neon Eye | Gaborandi",
        nl: "Neon Eye ondersteuning | Gaborandi",
        pl: "Pomoc Neon Eye | Gaborandi",
        sv: "Neon Eye support | Gaborandi",
        vi: "Hỗ trợ Neon Eye | Gaborandi",
      }[lang],
    },
    home: {
      ...NEON_I18N.en.home,
      ...
      privacyCta: {
        ...
        id: "Baca privasi",
        nl: "Privacy lezen",
        pl: "Przeczytaj prywatność",
        sv: "Läs integritet",
        vi: "Đọc quyền riêng tư",
      }[lang],
      supportCta: {
      ...
      demoGood: { fr: "BIEN", de: "GUT", pt: "BOM", it: "BENE", ja: "GOOD", ko: "좋음", zh: "不错", ru: "ХОРОШО", tr: "İYİ", hi: "अच्छा", id: "BAGUS", nl: "GOED", pl: "DOBRZE", sv: "BRA", vi: "TỐT" }[lang],
      demoMiss: { fr: "RATÉ", de: "DANEBEN", pt: "ERRO", it: "MANCATO", ja: "MISS", ko: "실패", zh: "错过", ru: "МИМО", tr: "KAÇTI", hi: "मिस", id: "MELESET", nl: "MIS", pl: "PUDŁO", sv: "MISS", vi: "TRƯỢT" }[lang],
      demoButtonLabel: { fr: "Essayer la fenêtre de timing de Neon Eye", de: "Das Neon Eye Timing-Fenster ausprobieren", pt: "Experimentar a janela de timing do Neon Eye", it: "Prova la finestra di tempismo di Neon Eye", ja: "Neon Eye のタイミング窓を試す", ko: "Neon Eye 타이밍 창 시도", zh: "试试 Neon Eye 的计时窗口", ru: "Попробовать окно тайминга Neon Eye", tr: "Neon Eye zamanlama penceresini dene", hi: "Neon Eye टाइमिंग विंडो आज़माएँ", id: "Coba jendela timing Neon Eye", nl: "Probeer het Neon Eye timingvenster", pl: "Wypróbuj okno timingu Neon Eye", sv: "Testa Neon Eyes timingfönster", vi: "Thử cửa sổ canh thời điểm Neon Eye" }[lang],
      lookCaption: { fr: "Captures réelles de la version actuelle de Neon Eye.", de: "Echte Screenshots aus dem aktuellen Neon Eye Build.", pt: "Capturas reais da versão atual do Neon Eye.", it: "Screenshot reali dalla build attuale di Neon Eye.", ja: "現在の Neon Eye ビルドから取得した実際のスクリーンショットです。", ko: "현재 Neon Eye 빌드에서 캡처한 실제 스크린샷입니다.", zh: "来自当前 Neon Eye 构建的真实截图。", ru: "Реальные снимки из текущей сборки Neon Eye.", tr: "Geçerli Neon Eye sürümünden alınmış gerçek ekran görüntüleri.", hi: "मौजूदा Neon Eye बिल्ड से ली गई वास्तविक स्क्रीनशॉट।", id: "Tangkapan layar asli dari build Neon Eye saat ini.", nl: "Echte screenshots uit de huidige Neon Eye-build.", pl: "Prawdziwe zrzuty ekranu z aktualnej wersji Neon Eye.", sv: "Riktiga skärmbilder från den aktuella Neon Eye-versionen.", vi: "Ảnh chụp thật từ bản dựng Neon Eye hiện tại." }[lang],
      menuShotCaption: { fr: "Menu principal actuel de la version du jeu.", de: "Aktuelles Hauptmenü aus dem Game-Build.", pt: "Menu principal atual da build do jogo.", it: "Menu principale attuale dalla build del gioco.", ja: "現在のゲームビルドのメインメニューです。", ko: "현재 게임 빌드의 메인 메뉴입니다.", zh: "当前游戏构建的主菜单。", ru: "Текущее главное меню из сборки игры.", tr: "Oyun sürümündeki güncel ana menü.", hi: "गेम बिल्ड का मौजूदा मुख्य मेनू।", id: "Menu utama saat ini dari build game.", nl: "Huidig hoofdmenu uit de game-build.", pl: "Aktualne menu główne z buildu gry.", sv: "Aktuell huvudmeny från spelbygget.", vi: "Menu chính hiện tại từ bản dựng game." }[lang],
      campaignShotCaption: { fr: "Écran de timing Campagne.", de: "Kampagnen-Timing-Bildschirm.", pt: "Tela de timing da Campanha.", it: "Schermata di tempismo Campagna.", ja: "キャンペーンのタイミング画面。", ko: "캠페인 타이밍 화면입니다.", zh: "战役计时画面。", ru: "Экран тайминга кампании.", tr: "Campaign zamanlama ekranı.", hi: "Campaign टाइमिंग स्क्रीन।", id: "Layar timing Campaign.", nl: "Campagne-timingscherm.", pl: "Ekran timingu kampanii.", sv: "Timingvy för Campaign.", vi: "Màn hình canh thời điểm Campaign." }[lang],
      fluxShotCaption: { fr: "Écran de pression Flux.", de: "Flux-Druckbildschirm.", pt: "Tela de pressão do Flux.", it: "Schermata di pressione Flux.", ja: "Flux のプレッシャー画面。", ko: "Flux 압박 화면입니다.", zh: "Flux 压力画面。", ru: "Экран давления Flux.", tr: "Flux baskı ekranı.", hi: "Flux प्रेशर स्क्रीन।", id: "Layar tekanan Flux.", nl: "Flux-drukscherm.", pl: "Ekran presji Flux.", sv: "Tryckvy för Flux.", vi: "Màn hình áp lực Flux." }[lang],
    },
    privacy: {
      ...NEON_I18N.en.privacy,
      title: {
        fr: "Politique de confidentialité de Neon Eye",
        de: "Neon Eye Datenschutzrichtlinie",
        pt: "Política de Privacidade do Neon Eye",
        it: "Informativa privacy di Neon Eye",
        ja: "Neon Eye プライバシーポリシー",
        ko: "Neon Eye 개인정보 처리방침",
        zh: "Neon Eye 隐私政策",
        ru: "Политика конфиденциальности Neon Eye",
        tr: "Neon Eye Gizlilik Politikası",
        hi: "Neon Eye गोपनीयता नीति",
        id: "Kebijakan Privasi Neon Eye",
        nl: "Neon Eye privacybeleid",
        pl: "Polityka prywatności Neon Eye",
        sv: "Neon Eye integritetspolicy",
    ...
    terms: {
      ...NEON_I18N.en.terms,
      title: {
        fr: "Conditions de Neon Eye",
        de: "Neon Eye Nutzungsbedingungen",
        pt: "Termos do Neon Eye",
        it: "Termini di Neon Eye",
        ja: "Neon Eye 利用規約",
        ko: "Neon Eye 약관",
        zh: "Neon Eye 条款",
        ru: "Условия Neon Eye",
        tr: "Neon Eye Şartları",
        hi: "Neon Eye शर्तें",
        id: "Ketentuan Neon Eye",
        nl: "Neon Eye voorwaarden",
        pl: "Warunki Neon Eye",
        sv: "Neon Eye villkor",
        vi: "Điều khoản Neon Eye",
      }[lang],
    },
    support: {
      ...NEON_I18N.en.support,
      title: {
        fr: "Assistance Neon Eye",
        de: "Neon Eye Support",
        pt: "Suporte Neon Eye",
        it: "Supporto Neon Eye",
        ja: "Neon Eye サポート",
        ko: "Neon Eye 지원",
        zh: "Neon Eye 支持",
        ru: "Поддержка Neon Eye",
        tr: "Neon Eye Destek",
        hi: "Neon Eye सहायता",
        id: "Dukungan Neon Eye",
        nl: "Neon Eye ondersteuning",
        pl: "Pomoc Neon Eye",
        sv: "Neon Eye support",
        vi: "Hỗ trợ Neon Eye",
      }[lang],
